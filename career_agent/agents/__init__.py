"""
Lightweight compatibility agents package to satisfy imports for the assignment.
Provides minimal Agent, Runner, handoff, OpenAIChatCompletionsModel, RunConfig, RunContextWrapper.
"""
...
class Runner:
    """Simple runner to emulate running an agent and returning a response."""
